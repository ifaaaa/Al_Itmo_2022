...
def draw_plt(predict_arr, expect_arr):
    ...
    auc_roc = auc(fpr, tpr)  # Нарийвчлал нь бүх зөвийг бүх өгөгдөлд харьцуулсан харьцааг илэрхийлдэг
...
class DecisionTree:
    ...
    # H(D) мэдээллийн энтропийг тооцоолох
    ...
    # Нөхцөлт энтропи H(Y/X)-ийг тооцоол.
    ...
    def _built_tree(self, X, y, depth=1):
        ...
        for best_feature in set(X[:, best_feature_index]):
            '''
            best_feature：Онцлог шинж чанарын ангилал
            '''
