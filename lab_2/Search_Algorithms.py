...
if __name__ == '__main__':
    ...
    G.DLS('Харьков', 'Ниж.Новгород', 10)
    G.IDDFS('Харьков', 'Ниж.Новгород', 10)
    G.BDS('Харьков', 'Ниж.Новгород')
    print("Informed Search:")
    G.GDFS('Харьков', 'Ниж.Новгород', True)
    G.GBFS('Харьков', 'Ниж.Новгород', True)
    G.heuristics('Ниж.Новгород')
    #G.print_heuristics_table()
    G.a_star('Харьков', 'Ниж.Новгород')
